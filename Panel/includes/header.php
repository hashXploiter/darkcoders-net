    ...
    <header>
        ...
        <div class="side-nav fixed" data-simplebar-direction="vertical" id="slide-menu">
            <ul class="side-nav-main">
                <li class="logo hide-on-med-and-down" id="logo-link"><img alt="logo" class="logo responsive-img" src="./assets/images/logo.jpg"><b>DarkCoders Net</b>	</li>
...
"></i></a>
                ...
                <li>
                    <a class="waves-effect"  href="?p=main"><i class="mdi-action-settings-input-svideo left"></i><span>Dashboard</span></a>
                </li>
                <li>
 ...
 left"></i><span>Settings</span></span></a>
                </li>
                <li>
                    <a class="waves-effect" href="?p=users"><i class="mdi-social-people left"></i><span>Users</span></a>
                </li>
				<li>
                    <a class="waves-effect" href="?p=logs"><i class="mdi-action-list left"></i><span>Panel Logs</span></a>
                </li>
