        ...
        <div class="z-depth-0 grey lighten-4 row" style="display: inline-block; padding: 1px 10px 0px 10px; border: 0px solid #EEE;">
           <div class="card">
            ...
            <div class="card-content">
               <span class="card-title activator grey-text text-darken-4">Login with Your Account<i class="material-icons btn-floating halfway-fab waves-effect waves-light grey right">add</i></span>
                 <p><a href="https://www.darkcoders.world">&copy; DarkC0ders.world</a></p>
            ...
            <center>
              <div class='row'>
                <button type='submit' name='doLogin' class='col s12 btn btn-large waves-effect indigo'>Login</button>
              </div>
            </center>
                 </form>
            </div>
